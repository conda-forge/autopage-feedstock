...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/autopage-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13711&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/autopage-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `autopage` can be installed with:

```
conda install autopage
```

It is possible to list all of the versions of `autopage` available on your platform with:
